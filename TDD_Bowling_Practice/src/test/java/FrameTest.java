...
public class FrameTest {
    ...
    void testFrameFirstSecond() {
        ...
        Assertions.assertEquals(8, frame.score);
    }
    ...
    void testSpareFlag() {
        ...
        Assertions.assertFalse(frame2.isSpare);
    }
    ...
    void testSpareCalc() {
        ...
        Assertions.assertEquals(18, frame.score);
        Assertions.assertNotEquals(10, frame.score);
        Assertions.assertEquals(8, frame2.score);
    }

    //3번 처리
    //Todo 스트라이크가 발생했을 때 점수 계산 Frame.score = 10 + First_Next_Frame.score + Second_Next_Frame.score
    //Todo 자신이 스트라이크라는 것을 알려줘야 한다
